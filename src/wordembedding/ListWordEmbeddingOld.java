...
public class ListWordEmbeddingOld {
...
//		interactiveConsole(synonyms_filename, wordembedding_filename);
	...
	public static void calculateAndSaveWordPairScores(String synonyms_filename, String wordembedding_filename, String wordPairScores_filename) throws IOException {
	...
	public static void interactiveConsole(String synonyms_filename, String wordembedding_filename) throws IOException {
	...
	public static void calculateAndSaveFrameSimilarity(String frames_filename, String wordembedding_filename, String synonyms_filename, String frameSimilarityFilename) throws IOException, InterruptedException {
	...
	public static void calculateFrameWithinSimilarity(ArrayList<SemanticFrame> frames, Object2DoubleOpenHashMap<UnorderedPair<String>> wps) throws IOException, InterruptedException {
	...
	/**
	 * calculates semantic similarities (based on word embedding) between pairs of connected edges in the given frame/graph. Uses the pair scores stored in the given wps argument.
	 * 
	 * @param frame
	 * @param wps
	 * @return
