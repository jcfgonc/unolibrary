...
public class BigInt extends Number implements Comparable<BigInt> {
	private static final long serialVersionUID = 7132456779746708020L;
	...
	/**
	 * The sign of this number. 1 for positive numbers and -1 for negative numbers. Zero can have either sign.
	 */
	private int sign;
	/**
	...
	/*** <Constructors> ***/
	/**
	 * Creates a BigInt from the given parameters. The input-array will be used as is and not be copied.
	 *
	 * @param sign
	 *            The sign of the number.
	 * @param v
	 *            The magnitude of the number, the first position gives the least significant 32 bits.
	 * @param len
	 *            The (first) number of entries of v that are considered part of the number.
	 * @complexity O(1)
	 */
	 ...
	 *            The sign of the number.
	 * @param v
	 *            The magnitude of the number, the first position gives the least significant 8 bits.
	 * @param len
	 *            The (first) number of entries of v that are considered part of the number.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param s
	 *            A string representing the number in decimal.
	 * @complexity O(n^2)
	 */
	 ...
	 *
	 * @param s
	 *            A char array representing the number in decimal.
	 * @complexity O(n^2)
	 */
	 ...
	 *            A char array representing the number in decimal.
	 * @param from
	 *            The index (inclusive) where we start parsing.
	 * @param to
	 *            The index (exclusive) where we stop parsing.
	 ...
	 *
	 * @param mul
	 *            The value we multiply our number with, mul < 2^31.
	 * @param add
	 *            The value we add to our number, add < 2^31.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param newLen
	 *            The new size of the magnitude array.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param The
	 *            BigInt to copy/assign to this BigInt.
	 * @complexity O(n)
	 */
	...
	/**
	 * Assigns the content of the given magnitude array and the length to this number. The contents of the input will be copied.
	 *
	 * @param v
	 *            The new magnitude array content.
	 * @param vlen
	 *            The length of the content, vlen > 0.
	 * @complexity O(n)
	 */
	...
	/**
	 * Assigns the given BigInt parameter to this number. The input magnitude array will be used as is and not copied.
	 *
	 * @param sign
	 *            The sign of the number.
	 * @param v
	 *            The magnitude of the number.
	 * @param len
	 *            The length of the magnitude array to be used.
	 * @complexity O(1)
	 */
	...
	/**
	 * Assigns the given BigInt parameter to this number. Assumes no leading zeroes of the input-array, i.e. that v[vlen-1]!=0, except for
	 * the case when vlen==1.
	 *
	 * @param sign
	 *            The sign of the number.
	 * @param v
	 ...
	 *            The sign of the number.
	 * @param val
	 *            The magnitude of the number (will be intepreted as unsigned).
	 * @complexity O(1)
	 */
	 ...
	 *
	 * @param val
	 *            The number interpreted as unsigned.
	 * @complexity O(1)
	 */
	 ...
	 *
	 * @param a
	 *            The number to be compared with.
	 ...
	 *
	 * @return the most significant 24 bits in the mantissa (the highest order bit obviously being implicit), the exponent value which will
	 *         be consistent for {@code BigInt}s up to 128 bits (should it not fit it'll be calculated modulo 256), and the sign bit set if
	 ...
	 *
	 * @return the most significant 53 bits in the mantissa (the highest order bit obviously being implicit), the exponent value which will
	 *         be consistent for {@code BigInt}s up to 1024 bits (should it not fit it'll be calculated modulo 2048), and the sign bit set
	 ...
	 *
	 * @param a
	 *            The amount of the increase (treated as unsigned).
	 * @complexity O(n)
	 * @amortized O(1)
	 */
	 ...
	 *
	 * @param s
	 *            The amount of the decrease (treated as unsigned).
	 * @complexity O(n)
	 * @amortized O(1)
	 */
	 ...
	 *
	 * @param a
	 *            The amount to add (treated as unsigned).
	 * @complexity O(n)
	 * @amortized O(1)
	 */
	 ...
	 *
	 * @param s
	 *            The amount to subtract (treated as unsigned).
	 * @complexity O(n)
	 * @amortized O(1)
	 */
	 ...
	 *
	 * @param mul
	 *            The amount to multiply (treated as unsigned).
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param div
	 *            The amount to divide with (treated as unsigned).
	 ...
	 *
	 * @param mod
	 *            The amount to modulo with (treated as unsigned).
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param v
	 *            The magnitude array of the increase.
	 * @param vlen
	 *            The length (number of digits) of the increase.
	 * @complexity O(n)
	 */
	...
	/**
	 * Decreases the magnitude of this number by the given magnitude array. Behaviour is undefined if u > |this|.
	 *
	 * @param u
	 *            The magnitude array of the decrease.
	 * @param vlen
	 *            The length (number of digits) of the decrease.
	 * @complexity O(n)
	 */
	...
	/**
	 * Multiplies this number by the given BigInt. Chooses the appropriate algorithm with regards to the size of the numbers.
	 *
	 * @param mul
	...
	/**
	 * Multiplies this number by the given (suitably small) BigInt. Uses a quadratic algorithm which is often suitable for smaller numbers.
	 *
	 * @param mul
	 *            The number to multiply with.
	 * @complexity O(n^2)
	...
	/**
	 * Multiplies this number by the given BigInt using the Karatsuba algorithm. The caller can choose to use a parallel version which is
	 * more suitable for larger numbers.
	 *
	 * @param mul
	 *            The number to multiply with.
	 * @param parallel
	 *            true if we should try to parallelize the algorithm, false if we shouldn't.
	 * @complexity O(n^1.585)
	 */
	 ...
	 *
	 * @param u
	 *            The first magnitude array.
	 * @param ulen
	 *            The length of the first array.
	 * @param v
	 *            The second magnitude array.
	 * @param vlen
	...
	/**
	 * Multiplies partial magnitude arrays x[off..off+n) and y[off...off+n) and returns the result. Algorithm: Karatsuba
	 *
	 * @param x
	 *            The first magnitude array.
	 * @param y
	 *            The second magnitude array.
	 * @param off
	 *            The offset, where the first element is residing.
	 * @param n
	 *            The length of each of the two partial arrays.
	 * @complexity O(n^1.585)
	 */
	...
	/**
	 * Multiplies partial magnitude arrays x[off..off+n) and y[off...off+n) and returns the result. Algorithm: Parallell Karatsuba
	 *
	 * @param x
	 *            The first magnitude array.
	 * @param y
	 ...
	 *            The length of each of the two partial arrays.
	 * @param lim
	 *            The recursion depth up until which we will spawn new threads.
	 * @param pool
	 *            Where spawn threads will be added and executed.
	 * @throws VariousUtils
	 ...
	 *
	 * @param div
	 *            The number to use in the division causing the remainder.
	 * @complexity O(n^2)
	 */
	...
	/**
	 * Divides this number by the given BigInt and returns the remainder. Division by zero is undefined.
	 *
	 * @param div
	 *            The number to divide with.
	...
	/**
	 * Divides the first magnitude u[0..m) by v[0..n) and stores the resulting quotient in q. The remainder will be stored in u, so u will
	 * be destroyed. u[] must have room for an additional element, i.e. u[m] is a legal access.
	 *
	 * @param u
	 *            The first magnitude array, the dividend.
	 * @param v
	 *            The second magnitude array, the divisor.
	 * @param m
	 *            The length of the first array.
	 * @param n
	 *            The length of the second array.
	 * @param q
	 *            An array of length at least n-m+1 where the quotient will be stored.
	 * @complexity O(m*n)
	 */
	private void div(final int[] u, final int[] v, final int m, final int n, final int[] q) {// Hacker'sDelight's implementation of Knuth's
																								// Algorithm D
	...
	/**
	 * Shifts this number left by the given amount (less than 32) starting at the given digit, i.e. the first (<len) digits are left
	 * untouched.
	 *
	 * @param shift
	 *            The amount to shift.
	 * @param first
	 *            The digit to start shifting from.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param shift
	 *            The number of positions to move each digit.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param mask
	 *            The number to bitwise-and with.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param mask
	 *            The number to bitwise-xor with.
	 * @complexity O(n)
	 */
	 ...
	 *
	 * @param mask
	 *            The number to bitwise-and-not with.
	 * @complexity O(n)
	 */
	...
	/**
	 * Inverts sign and all bits of this number, i.e. this = ~this. The identity -this = ~this + 1 holds.
	 *
	 * @complexity O(n)
	 */
	public void not() {
